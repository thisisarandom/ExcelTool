    ...
    public class GenModels
    {
        ...
        public static bool GenCSharpModel(string fileName, string outputDir)
        {
            ...
            try
            {
                ...
                sb.Append("\n");
                sb.Append("[Serializable]\n");
                sb.Append($"public partial class {excelName}Config : ScriptableObject,IBinarySerializable\n");
                sb.Append("{\n");
                sb.Append($"\tpublic {excelName}[] {excelName}Infos;\n");
                sb.Append($"\tpublic void DeSerialize(BinaryReader reader)\n");
                sb.Append("\t{\n");
                sb.Append($"\t\tint count = reader.ReadInt32();\n");
                sb.Append($"\t\t{excelName}Infos = new {excelName}[count];\n");
                sb.Append($"\t\tfor (int i = 0;i < count; i++)\n");
                sb.Append("\t\t{\n");
                sb.Append($"\t\t\t{excelName} tempData = new {excelName}();\n");
                sb.Append($"\t\t\ttempData.DeSerialize(reader);\n");
                sb.Append($"\t\t\t{excelName}Infos[i] = tempData;\n");
                sb.Append("\t\t}\n");
                sb.Append("\t}\n");
                sb.Append("\n");
                sb.Append("\tpublic void Serialize(BinaryWriter writer)\n");
                sb.Append("\t{\n");
                sb.Append($"\t\twriter.Write({excelName}Infos.Length);\n");
                sb.Append($"\t\tfor (int i = 0; i < {excelName}Infos.Length; i++)\n");
                sb.Append("\t\t{\n");
                ...
                sb.Append("\t{\n");
                sb.Append($"\t\tvar datas = {excelName}Infos.FirstOrDefault(x => x.Id == id);\n");
